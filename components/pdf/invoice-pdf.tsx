...
export function InvoicePdfDocument({ data, companyName }: InvoicePdfDocumentProps) {
  const description = data.type ? data.type.charAt(0).toUpperCase() + data.type.slice(1) : "Invoice";
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.sectionText}>{data.billTo.name}</Text>
          {data.billTo.email && (
            <Text style={styles.sectionText}>{data.billTo.email}</Text>
          )}
          {data.billTo.phone && (
            <Text style={styles.sectionText}>{data.billTo.phone}</Text>
          )}
        </View>
